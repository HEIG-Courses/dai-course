...
format:
  revealjs:
    theme: [default, ../assets/dai-slides.scss]
    logo: ../assets/heig-vd.svg
    slide-number: true
    transition: none
    footer: "HEIG-VD · DAI 2026–2027 · CC BY-SA 4.0"
...
:::
::: {.column width="50%"}
![](../chapters/images/05-docker/code-examples-github-repository.png)
:::
:::
...
- v2 = `docker compose` (v1 `docker-compose` is deprecated).
:::
::: {.column width="45%"}
...
:::
::: {.column width="45%"}
![](../chapters/images/05-docker/what-will-you-do.png)
:::
:::
